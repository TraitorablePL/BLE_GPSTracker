...
#define CONTROL_SERVICE_BASE_UUID {{0xBA, 0x9F, 0xE0, 0x3D, 0x4E, 0x59, 0xA0, 0x9E, 0x09, 0x4B, 0x7C, 0x53, 0xB4, 0xD9, 0xDE, 0x54}} // 128-bit base UUID Little Endian format
